...
<div class="section group section-member" id="joinSection">
    ...
    <div class="wrap-member-box wrap-join-box">
        ...
        <form name="form-join" id="form-join" method="post" action="/Member/Confirm">
            <div class="wrap-inside">
                <div class="join-social-desc">
                    <span>소셜 계정으로 가입</span>
                </div>
                <div class="join-social">
                    <div id="naver_id_login" class="nv"><a href="https://nid.naver.com/oauth2.0/authorize?response_type=token&amp;client_id=i5vJc9KektcyYpcRyM5n&amp;redirect_uri=https%3A%2F%2Fcineq.co.kr%2FPopup%2FNaverLogin&amp;state=63fbad94-92d6-45b2-9eb3-b879e454a289" onclick="window.open(this.href, 'naverloginpop', 'titlebar=1, resizable=1, scrollbars=yes, width=600, height=550'); return false" id="naver_id_login_anchor" class="social-connect nv">네이버</a> </div>
                    <a id="custom-login-btn" href="javascript:joinWithKakao();" class="kt">카카오톡</a>
                </div>
            ...
            <a href="javascript:;" id="btn-join" class="btn-join">가입하기</a>
