...
<body>
	<div id="header" class="pc">
		<div class="inner">
			...
			<div class="menus">
				...
				<div class="etc">
					<a href="javascript:goLink('/member/logout.do');">로그아웃</a>
					</div>
	...
	<form id="dataForm" method="post" action="/reserve/payment.do">
				...
				<input type="hidden" id="ssid" name="ssid" value="A63E1ECB-B506-4F76-90E5-B484102A129F">
				<input type="hidden" id="tokn" name="tokn" value="47054350">
				...
				<input type="hidden" id="StartTime" name="StartTime" value="14:15">
				<input type="hidden" id="EndTime" name="EndTime" value="16:17">
				...
				<input type="hidden" id="TicketCd" name="TicketCd" value="000060">
				<input type="hidden" id="TicketNm" name="TicketNm" value="성인">
				<input type="hidden" id="TicketAmt" name="TicketAmt" value="6000.0000">
				<input type="hidden" id="TicketTotalCnt" name="TicketTotalCnt" value="1">
				<input type="hidden" id="TicketTotalAmt" name="TicketTotalAmt" value="6000">
								...
								<div class="body">
									<div class="r-choice">
										...
										<div class="scroll-choice">
											<div class="scroll-wrapper scrollbar-inner" style="position: relative;"><div class="scrollbar-inner scroll-content" style="height: 480px; margin-bottom: 0px; margin-right: 0px; max-height: none;">
												<div id="priceList"><div class="t1">성인</div><div class="list"><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="0" data-no="0" checked="">	<span>0</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="1" data-no="0">	<span>1</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="2" data-no="0">	<span>2</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="3" data-no="0">	<span>3</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="4" data-no="0">	<span>4</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="5" data-no="0">	<span>5</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="6" data-no="0">	<span>6</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="7" data-no="0">	<span>7</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000060" value="8" data-no="0">	<span>8</span></label></div><div class="t1">경로(만65세이상)</div><div class="list"><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="0" data-no="1" checked="">	<span>0</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="1" data-no="1">	<span>1</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="2" data-no="1">	<span>2</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="3" data-no="1">	<span>3</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="4" data-no="1">	<span>4</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="5" data-no="1">	<span>5</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="6" data-no="1">	<span>6</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="7" data-no="1">	<span>7</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000071" value="8" data-no="1">	<span>8</span></label></div><div class="t1">청소년</div><div class="list"><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="0" data-no="2" checked="">	<span>0</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="1" data-no="2">	<span>1</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="2" data-no="2">	<span>2</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="3" data-no="2">	<span>3</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="4" data-no="2">	<span>4</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="5" data-no="2">	<span>5</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="6" data-no="2">	<span>6</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="7" data-no="2">	<span>7</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000061" value="8" data-no="2">	<span>8</span></label></div><div class="t1">군인(용사)</div><div class="list"><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="0" data-no="3" checked="">	<span>0</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="1" data-no="3">	<span>1</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="2" data-no="3">	<span>2</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="3" data-no="3">	<span>3</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="4" data-no="3">	<span>4</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="5" data-no="3">	<span>5</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="6" data-no="3">	<span>6</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="7" data-no="3">	<span>7</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000064" value="8" data-no="3">	<span>8</span></label></div><div class="t1">장애인</div><div class="list"><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="0" data-no="4" checked="">	<span>0</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="1" data-no="4">	<span>1</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="2" data-no="4">	<span>2</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="3" data-no="4">	<span>3</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="4" data-no="4">	<span>4</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="5" data-no="4">	<span>5</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="6" data-no="4">	<span>6</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="7" data-no="4">	<span>7</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000069" value="8" data-no="4">	<span>8</span></label></div><div class="t1">국가유공자</div><div class="list"><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="0" data-no="5" checked="">	<span>0</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="1" data-no="5">	<span>1</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="2" data-no="5">	<span>2</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="3" data-no="5">	<span>3</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="4" data-no="5">	<span>4</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="5" data-no="5">	<span>5</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="6" data-no="5">	<span>6</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="7" data-no="5">	<span>7</span></label><label class="">	<input type="radio" class="c-radio rdoTicket" name="T000070" value="8" data-no="5">	<span>8</span></label></div></div>
														...
														<div id="ssSeat" class="seatWrap">
															<div class="seatSelectWrapper">
																<div class="seatSelectContainer">
																	<div class="seatMap" id="seatMap" style="width: 612px; height: 324px;"><div class="child" style="top:36px;left:0px">A</div><div class="child" style="top:72px;left:0px">B</div><div class="child" style="top:108px;left:0px">C</div><div class="child" style="top:144px;left:0px">D</div><div class="child" style="top:180px;left:0px">E</div><div class="child" style="top:216px;left:0px">F</div><div class="child" style="top:252px;left:0px">G</div><button type="button" data-id="0" class="seat soldout" style="top:36px;left:72px;background-color:#3D3F51" disabled="">A2</button><button type="button" data-id="1" class="seat available" style="top: 36px; left: 144px; background-color: rgb(200, 200, 200);">A3</button><button type="button" data-id="2" class="seat available soldout" style="top:36px;left:180px;background-color:#C8C8C8">A4</button><button type="button" data-id="3" class="seat available" style="top:36px;left:216px;background-color:#C8C8C8">A5</button><button type="button" data-id="4" class="seat available" style="top:36px;left:252px;background-color:#C8C8C8">A6</button><button type="button" data-id="5" class="seat available" style="top:36px;left:288px;background-color:#C8C8C8">A7</button><button type="button" data-id="6" class="seat available" style="top: 36px; left: 324px; background-color: rgb(200, 200, 200);">A8</button><button type="button" data-id="7" class="seat available" style="top:36px;left:360px;background-color:#C8C8C8">A9</button><button type="button" data-id="8" class="seat available soldout" style="top:36px;left:396px;background-color:#C8C8C8">A10</button><button type="button" data-id="9" class="seat available" style="top:36px;left:432px;background-color:#C8C8C8">A11</button><button type="button" data-id="10" class="seat soldout" style="top:36px;left:504px;background-color:#3D3F51" disabled="">A12</button><button type="button" data-id="11" class="seat available" style="top:72px;left:36px;background-color:#C8C8C8">B1</button><button type="button" data-id="12" class="seat available" style="top:72px;left:72px;background-color:#C8C8C8">B2</button><button type="button" data-id="13" class="seat available" style="top: 72px; left: 144px; background-color: rgb(200, 200, 200);">B3</button><button type="button" data-id="14" class="seat available soldout" style="top:72px;left:180px;background-color:#C8C8C8">B4</button><button type="button" data-id="15" class="seat available" style="top:72px;left:216px;background-color:#C8C8C8">B5</button><button type="button" data-id="16" class="seat available" style="top:72px;left:252px;background-color:#C8C8C8">B6</button><button type="button" data-id="17" class="seat available" style="top:72px;left:288px;background-color:#C8C8C8">B7</button><button type="button" data-id="18" class="seat available" style="top: 72px; left: 324px; background-color: rgb(200, 200, 200);">B8</button><button type="button" data-id="19" class="seat available" style="top:72px;left:360px;background-color:#C8C8C8">B9</button><button type="button" data-id="20" class="seat available soldout" style="top:72px;left:396px;background-color:#C8C8C8">B10</button><button type="button" data-id="21" class="seat available" style="top: 72px; left: 432px; background-color: rgb(200, 200, 200);">B11</button><button type="button" data-id="22" class="seat available" style="top: 72px; left: 504px; background-color: rgb(200, 200, 200);">B12</button><button type="button" data-id="23" class="seat available" style="top:72px;left:540px;background-color:#C8C8C8">B13</button><button type="button" data-id="24" class="seat available" style="top:108px;left:36px;background-color:#C8C8C8">C1</button><button type="button" data-id="25" class="seat available" style="top:108px;left:72px;background-color:#C8C8C8">C2</button><button type="button" data-id="26" class="seat available" style="top:108px;left:144px;background-color:#C8C8C8">C3</button><button type="button" data-id="27" class="seat available soldout" style="top:108px;left:180px;background-color:#C8C8C8">C4</button><button type="button" data-id="28" class="seat available" style="top:108px;left:216px;background-color:#C8C8C8">C5</button><button type="button" data-id="29" class="seat available" style="top:108px;left:252px;background-color:#C8C8C8">C6</button><button type="button" data-id="30" class="seat available" style="top:108px;left:288px;background-color:#C8C8C8">C7</button><button type="button" data-id="31" class="seat available" style="top: 108px; left: 324px; background-color: rgb(200, 200, 200);">C8</button><button type="button" data-id="32" class="seat available" style="top: 108px; left: 360px; background-color: rgb(200, 200, 200);">C9</button><button type="button" data-id="33" class="seat available soldout" style="top:108px;left:396px;background-color:#C8C8C8">C10</button><button type="button" data-id="34" class="seat available" style="top:108px;left:432px;background-color:#C8C8C8">C11</button><button type="button" data-id="35" class="seat available" style="top:108px;left:504px;background-color:#C8C8C8">C12</button><button type="button" data-id="36" class="seat available" style="top:108px;left:540px;background-color:#C8C8C8">C13</button><button type="button" data-id="37" class="seat available" style="top:144px;left:36px;background-color:#C8C8C8">D1</button><button type="button" data-id="38" class="seat available" style="top:144px;left:72px;background-color:#C8C8C8">D2</button><button type="button" data-id="39" class="seat available" style="top: 144px; left: 144px; background-color: rgb(200, 200, 200);">D3</button><button type="button" data-id="40" class="seat available soldout" style="top:144px;left:180px;background-color:#C8C8C8">D4</button><button type="button" data-id="41" class="seat available" style="top: 144px; left: 216px; background-color: rgb(200, 200, 200);">D5</button><button type="button" data-id="42" class="seat available" style="top:144px;left:252px;background-color:#C8C8C8">D6</button><button type="button" data-id="43" class="seat available" style="top:144px;left:288px;background-color:#C8C8C8">D7</button><button type="button" data-id="44" class="seat available" style="top: 144px; left: 324px; background-color: rgb(200, 200, 200);">D8</button><button type="button" data-id="45" class="seat available" style="top:144px;left:360px;background-color:#C8C8C8">D9</button><button type="button" data-id="46" class="seat available soldout" style="top:144px;left:396px;background-color:#C8C8C8">D10</button><button type="button" data-id="47" class="seat available" style="top:144px;left:432px;background-color:#C8C8C8">D11</button><button type="button" data-id="48" class="seat available" style="top:144px;left:504px;background-color:#C8C8C8">D12</button><button type="button" data-id="49" class="seat available" style="top:144px;left:540px;background-color:#C8C8C8">D13</button><button type="button" data-id="50" class="seat available" style="top:180px;left:36px;background-color:#C8C8C8">E1</button><button type="button" data-id="51" class="seat available" style="top:180px;left:72px;background-color:#C8C8C8">E2</button><button type="button" data-id="52" class="seat available" style="top: 180px; left: 144px; background-color: rgb(200, 200, 200);">E3</button><button type="button" data-id="53" class="seat available soldout" style="top:180px;left:180px;background-color:#C8C8C8">E4</button><button type="button" data-id="54" class="seat available" style="top: 180px; left: 216px; background-color: rgb(200, 200, 200);">E5</button><button type="button" data-id="55" class="seat available" style="top:180px;left:252px;background-color:#C8C8C8">E6</button><button type="button" data-id="56" class="seat available" style="top:180px;left:288px;background-color:#C8C8C8">E7</button><button type="button" data-id="57" class="seat available" style="top: 180px; left: 324px; background-color: rgb(200, 200, 200);">E8</button><button type="button" data-id="58" class="seat available" style="top:180px;left:360px;background-color:#C8C8C8">E9</button><button type="button" data-id="59" class="seat available soldout" style="top:180px;left:396px;background-color:#C8C8C8">E10</button><button type="button" data-id="60" class="seat available" style="top:180px;left:432px;background-color:#C8C8C8">E11</button><button type="button" data-id="61" class="seat available" style="top: 180px; left: 504px; background-color: rgb(200, 200, 200);">E12</button><button type="button" data-id="62" class="seat available" style="top:180px;left:540px;background-color:#C8C8C8">E13</button><button type="button" data-id="63" class="seat available" style="top:216px;left:36px;background-color:#C8C8C8">F1</button><button type="button" data-id="64" class="seat available" style="top: 216px; left: 72px; background-color: rgb(200, 200, 200);">F2</button><button type="button" data-id="65" class="seat available" style="top: 216px; left: 144px; background-color: rgb(200, 200, 200);">F3</button><button type="button" data-id="66" class="seat available soldout" style="top:216px;left:180px;background-color:#C8C8C8">F4</button><button type="button" data-id="67" class="seat available" style="top: 216px; left: 216px; background-color: rgb(200, 200, 200);">F5</button><button type="button" data-id="68" class="seat available" style="top: 216px; left: 252px; background-color: rgb(200, 200, 200);">F6</button><button type="button" data-id="69" class="seat available" style="top:216px;left:288px;background-color:#C8C8C8">F7</button><button type="button" data-id="70" class="seat available" style="top:216px;left:324px;background-color:#C8C8C8">F8</button><button type="button" data-id="71" class="seat available" style="top:216px;left:360px;background-color:#C8C8C8">F9</button><button type="button" data-id="72" class="seat available soldout" style="top:216px;left:396px;background-color:#C8C8C8">F10</button><button type="button" data-id="73" class="seat available" style="top: 216px; left: 432px; background-color: rgb(200, 200, 200);">F11</button><button type="button" data-id="74" class="seat available" style="top: 216px; left: 504px; background-color: rgb(200, 200, 200);">F12</button><button type="button" data-id="75" class="seat available" style="top:216px;left:540px;background-color:#C8C8C8">F13</button><button type="button" data-id="76" class="seat soldout" style="top:252px;left:36px;background-color:#3D3F51" disabled="">G1</button><button type="button" data-id="77" class="seat soldout" style="top:252px;left:72px;background-color:#3D3F51" disabled="">G2</button><button type="button" data-id="78" class="seat available" style="top:252px;left:144px;background-color:#C8C8C8">G3</button><button type="button" data-id="79" class="seat available soldout" style="top:252px;left:180px;background-color:#C8C8C8">G4</button><button type="button" data-id="80" class="seat available" style="top: 252px; left: 216px; background-color: rgb(200, 200, 200);">G5</button><button type="button" data-id="81" class="seat available" style="top:252px;left:252px;background-color:#C8C8C8">G6</button><button type="button" data-id="82" class="seat available" style="top:252px;left:288px;background-color:#C8C8C8">G7</button><button type="button" data-id="83" class="seat available" style="top:252px;left:324px;background-color:#C8C8C8">G8</button><button type="button" data-id="84" class="seat available" style="top:252px;left:360px;background-color:#C8C8C8">G9</button><button type="button" data-id="85" class="seat available soldout" style="top:252px;left:396px;background-color:#C8C8C8">G10</button><button type="button" data-id="86" class="seat available" style="top:252px;left:432px;background-color:#C8C8C8">G11</button><button type="button" data-id="87" class="seat available" style="top:252px;left:504px;background-color:#C8C8C8">G12</button><button type="button" data-id="88" class="seat available" style="top:252px;left:540px;background-color:#C8C8C8">G13</button></div>
																</div>
															</div>
														</div>
													</div>
