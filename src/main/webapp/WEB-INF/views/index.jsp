				...
				<div class="wrap-slider wrap-bo">
					<ul class="bxslider-bo">
						...
						<span class="over over-a"> 
							...
							<a href="">
								<img src="resources/images/movies/poster/m1.jpg" />
						...
						<span class="over over-a">
							...
							<a href="">
								<img src="resources/images/movies/poster/m2.jpg" />
								<div class="movie-desc">
									</span>스즈메의 문단속
								</div>
							</a>
						...
						<li data-moviecode=""><span class="over over-a">
							...
							<a href="">
								<img src="resources/images/movies/poster/m3.jpg" />
								<div class="movie-desc">
									스즈메의 문단속
								</div>
						</a>
						...
						<div class="like-btn">
							  <a href="javascript:;" class="icon heart">
							     <img src="resources/images/ico/before-like.png" alt="찜하기"><span class="likeNum">50K</span>
							  </a>
						</div>
						...
						<div class="like-btn">
							  <a href="javascript:;" class="icon heart">
							     <img src="resources/images/ico/before-like.png" alt="찜하기"><span class="likeNum">60K</span>
							  </a>
						</div>
						...
						<div class="like-btn">
							  <a href="javascript:;" class="icon heart">
							     <img src="resources/images/ico/before-like.png" alt="찜하기"><span class="likeNum">46K</span>
							  </a>
						</div>
						...
						<div class="like-btn">
							  <a href="javascript:;" class="icon heart">
							     <img src="resources/images/ico/before-like.png" alt="찜하기"><span class="likeNum">21</span>
							  </a>
						</div>
				...
				<ul class="giftcon_list_wrap">
                        ...
                        <li>
                            <dl class="giftcon_list">
                                <dt>패키지<a href="${path }/store/store_main.jsp?" alt="패키지" class="btn_more pak">더보기</a></dt>
                               
                                <dd>
                                    <a href="${path }/store/store_main.jsp">
                                        <div class="img_wrap" data-scale="false"><img src="resources/images/store/pk1.png" alt="우리 패키지"></div>
                                ...
                                <dd>
                                    <a href="">
                                        <div class="img_wrap" data-scale="false"><img src="resources/images/store/pk2.png" alt="나랑 너 패키지"></div>
                                        <div class="giftcon_info_wrap">
                                            <span>러브콤보 패키지</span>
                                ...
                                <dd>
                                    <a href="">
                                        <div class="img_wrap" data-scale="false"><img src="resources/images/store/pk3.png" alt="좋은 날 패키지"></div>
                                        <div class="giftcon_info_wrap">
                                            <span>패밀리 패키지</span>
                        ...
                        <li>
                            <dl class="giftcon_list">
                                <dt>베스트리뷰<a href="" alt="베스트리뷰" class="btn_more">더보기</a></dt>
                    ...
                    <div class="noticeClient_container">
                        <div class="noticeClient_content">
                            <div id="ctl00_PlaceHolderContent_notice_wrap" class="notice_wrap">
                                ...
                                <a href="${path }/customer_center/cc_home.jsp" id="notice_more" class="btn_more">더보기</a>
                            </div>
                        ...
                        <div class="qr_wrap">
                            ...
                            <div class="img_wrap" data-scale="false"><img src="resources/images/main/img_qrcode.png" alt="QR CODE"></div>
