				...
				<div class="custo-main">
					<div class="main-block">
						<div class="block-content">
							<a href="miss_question.jsp" title="분실물 문의 페이지로 이동">
								<p>
							...
							<div class="">
								<ol class="decimal-list">
									...
									<li><a href="" class="faqBtn" data-idx="4" title="질문 상세보기">
											...
											class="font-gblue">[VIP]</span> 회원 등급 조정 기간 동안의 관람 실적은 어떻게
											반영되나요? <span class="date">2023.03.07</span>
									</a></li>
								...
								<ol>
									...
									<li><a href="" class="moveBtn" data-no="10813"
										title="공지사항 상세보기"> <span class="font-purple"><i
												class="iconset ico-marker"></i> [전대(광주)]</span> [전대(광주)] 관람요금 변경 안내
											(4/17부터~) <span class="date">2023.03.28</span>
									</a></li>

									<li><a href="" class="moveBtn" data-no="10812"
										title="공지사항 상세보기"> <span class="font-purple"><i
												class="iconset ico-marker"></i> [원주]</span> [원주] 운영시간 변경 공지 <span
											class="date">2023.03.28</span>
									</a></li>

									<li><a href="" class="moveBtn" data-no="10811"
										title="공지사항 상세보기"> <span class="font-purple"><i
												class="iconset ico-marker"></i> [상암월드컵경기장]</span> [상암월드컵경기장]3월
											28일(화) 축구 국가대표 평가전에 따른 주차안내 <span class="date">2023.03.28</span>
									</a></li>

									<li><a href="" class="moveBtn" data-no="10809"
										title="공지사항 상세보기"> <span class="font-purple"><i
												class="iconset ico-marker"></i> [원주센트럴]</span> [원주센트럴] 운영시간 변경 안내
											(3/27부터~ 별도 공지까지) <span class="date">2023.03.22</span>
									</a></li>

									<li><a href="" class="moveBtn" data-no="10808"
										title="공지사항 상세보기"> <span class="font-purple"><i
												class="iconset ico-marker"></i> [전주객사]</span> [전주객사] 2023년 03월 17일
											신규 OPEN! (이벤트 안내) <span class="date">2023.03.17</span>
									</a></li>
