...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="reservation_ver3"></meta>
    
    <link rel="stylesheet" href="../css/res/common.css">
    <link rel="stylesheet" href="../css/res/content.css">
    <link rel="stylesheet" href="../css/res/custom.css">
    <link rel="stylesheet" href="../css/res/eggupdate.css">
    <link rel="stylesheet" href="../css/res/favicon.css">
    <link rel="stylesheet" href="../css/res/layout.css">
    <link rel="stylesheet" href="../css/res/module.css">
    <link rel="stylesheet" href="../css/res/print.css">
    <link rel="stylesheet" href="../css/res/reset.css">
    <link rel="stylesheet" href="../css/res/webfont.css">
...
<div class="nav">
    ...
    <iframe title="CGV 빠른예매" id="ticket_iframe" src="http://ticket.cgv.co.kr/Reservation/Reservation.aspx?MOVIE_CD=&MOVIE_CD_GROUP=&PLAY_YMD=&THEATER_CD=&PLAY_NUM=&PLAY_START_TM=&AREA_CD=&SCREEN_CD=&THIRD_ITEM=&SCREEN_RATING_CD=" 
        scrolling="no" frameborder="0" width="100%" height="1100px" style="width:100%; border:0 none;"></iframe>
